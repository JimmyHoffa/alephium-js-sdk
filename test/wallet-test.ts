...
describe('Wallet', function () {
  ...
  describe('should derive a new address', () => {
    ...
    it('of a specific path index', () => {
      expect(walletUtils.getPath('account')).toEqual("m/44'/1234'/0'/0/0")
      expect(walletUtils.getPath('account', 0)).toEqual("m/44'/1234'/0'/0/0")
      expect(walletUtils.getPath('account', 1)).toEqual("m/44'/1234'/0'/0/1")
      expect(walletUtils.getPath('account', 2)).toEqual("m/44'/1234'/0'/0/2")
      expect(walletUtils.getPath('account', 3)).toEqual("m/44'/1234'/0'/0/3")
      expect(walletUtils.getPath('account', 3)).toEqual("m/44'/1234'/0'/0/3")
      expect(walletUtils.getPath('account', 4)).toEqual("m/44'/1234'/0'/0/4")
      expect(walletUtils.getPath('account', 9999)).toEqual("m/44'/1234'/0'/0/9999")
      expect(walletUtils.getPath('account', 1e18)).toEqual("m/44'/1234'/0'/0/1000000000000000000")
      expect(() => walletUtils.getPath('account', -1)).toThrowError('Invalid address index path level')
      expect(() => walletUtils.getPath('account', 0.1)).toThrowError('Invalid address index path level')
      expect(() => walletUtils.getPath('account', -0.1)).toThrowError('Invalid address index path level')
      expect(() => walletUtils.getPath('account', 1e21)).toThrowError('Invalid address index path level')
      expect(() => walletUtils.getPath('account', 1e-21)).toThrowError('Invalid address index path level')
      expect(() => walletUtils.getPath('account', 1e-18)).toThrowError('Invalid address index path level')
    })
  })
})
